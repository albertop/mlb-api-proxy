"""Unit tests for standings router."""
...
@pytest.mark.parametrize(
    ...
    [
        ("/api/v1/standings/test_value", "standings", "View standings for a league"),
        ("/api/v1/standings", "standings_1", "View standings for a league"),
    ],
)
def test_standings_endpoint_exists(
    client: TestClient, endpoint_path: str, operation_id: str, summary: str, respx_mock
):
    """Test that standings endpoint exists and returns expected structure."""
...
@pytest.mark.unit
def test_standings_endpoints_require_valid_upstream(client: TestClient, respx_mock):
    """Test that standings endpoints handle upstream failures gracefully."""
...
@pytest.mark.unit
def test_standings_endpoints_forward_query_params(client: TestClient, respx_mock):
    """Test that standings endpoints forward query parameters correctly."""
