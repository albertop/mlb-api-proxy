"""Unit tests for uniforms router."""
...
@pytest.mark.parametrize(
    ...
    [
        ("/api/v1/uniforms/team", "uniformsByTeam", "View Team Uniform info"),
        ("/api/v1/uniforms/game", "uniformsByGame", "View Game Uniform info"),
    ],
)
def test_uniforms_endpoint_exists(
    client: TestClient, endpoint_path: str, operation_id: str, summary: str, respx_mock
):
    """Test that uniforms endpoint exists and returns expected structure."""
...
@pytest.mark.unit
def test_uniforms_endpoints_require_valid_upstream(client: TestClient, respx_mock):
    """Test that uniforms endpoints handle upstream failures gracefully."""
...
@pytest.mark.unit
def test_uniforms_endpoints_forward_query_params(client: TestClient, respx_mock):
    """Test that uniforms endpoints forward query parameters correctly."""
