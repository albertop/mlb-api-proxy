"""Unit tests for attendance router."""
...
@pytest.mark.parametrize(
    ...
    [("/api/v1/attendance", "getTeamAttendance", "Get team attendance")],
)
def test_attendance_endpoint_exists(
    client: TestClient, endpoint_path: str, operation_id: str, summary: str, respx_mock
):
    """Test that attendance endpoint exists and returns expected structure."""
...
@pytest.mark.unit
def test_attendance_endpoints_require_valid_upstream(client: TestClient, respx_mock):
    """Test that attendance endpoints handle upstream failures gracefully."""
...
@pytest.mark.unit
def test_attendance_endpoints_forward_query_params(client: TestClient, respx_mock):
    """Test that attendance endpoints forward query parameters correctly."""
