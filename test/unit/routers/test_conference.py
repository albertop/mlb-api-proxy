"""Unit tests for conference router."""
...
@pytest.mark.parametrize(
    ...
    [
        ("/api/v1/conferences", "conferences", "View conference info"),
        ("/api/v1/conferences/123", "conferences_1", "View conference info"),
    ],
)
def test_conference_endpoint_exists(
    client: TestClient, endpoint_path: str, operation_id: str, summary: str, respx_mock
):
    """Test that conference endpoint exists and returns expected structure."""
...
@pytest.mark.unit
def test_conference_endpoints_require_valid_upstream(client: TestClient, respx_mock):
    """Test that conference endpoints handle upstream failures gracefully."""
...
@pytest.mark.unit
def test_conference_endpoints_forward_query_params(client: TestClient, respx_mock):
    """Test that conference endpoints forward query parameters correctly."""
