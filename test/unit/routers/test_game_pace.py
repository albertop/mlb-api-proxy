"""Unit tests for game_pace router."""
...
@pytest.mark.parametrize(
    ...
    [("/api/v1/gamePace", "gamePace", "View time of game info")],
)
def test_game_pace_endpoint_exists(
    client: TestClient, endpoint_path: str, operation_id: str, summary: str, respx_mock
):
    """Test that game_pace endpoint exists and returns expected structure."""
...
@pytest.mark.unit
def test_game_pace_endpoints_require_valid_upstream(client: TestClient, respx_mock):
    """Test that game_pace endpoints handle upstream failures gracefully."""
...
@pytest.mark.unit
def test_game_pace_endpoints_forward_query_params(client: TestClient, respx_mock):
    """Test that game_pace endpoints forward query parameters correctly."""
