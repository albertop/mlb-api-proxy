"""Unit tests for broadcast router."""
...
@pytest.mark.parametrize(
    ...
    [
        ("/api/v1/broadcasters", "getAllBroadcasters", "Get All Active Broadcasters"),
        ("/api/v1/broadcast", "getBroadcasts", "Get Broadcasters"),
    ],
)
def test_broadcast_endpoint_exists(
    client: TestClient, endpoint_path: str, operation_id: str, summary: str, respx_mock
):
    """Test that broadcast endpoint exists and returns expected structure."""
...
@pytest.mark.unit
def test_broadcast_endpoints_require_valid_upstream(client: TestClient, respx_mock):
    """Test that broadcast endpoints handle upstream failures gracefully."""
...
@pytest.mark.unit
def test_broadcast_endpoints_forward_query_params(client: TestClient, respx_mock):
    """Test that broadcast endpoints forward query parameters correctly."""
