"""Unit tests for division router."""
...
@pytest.mark.parametrize(
    ...
    [
        ("/api/v1/divisions", "divisions", "Get division information"),
        ("/api/v1/divisions/123", "divisions_1", "Get division information"),
    ],
)
def test_division_endpoint_exists(
    client: TestClient, endpoint_path: str, operation_id: str, summary: str, respx_mock
):
    """Test that division endpoint exists and returns expected structure."""
...
@pytest.mark.unit
def test_division_endpoints_require_valid_upstream(client: TestClient, respx_mock):
    """Test that division endpoints handle upstream failures gracefully."""
...
@pytest.mark.unit
def test_division_endpoints_forward_query_params(client: TestClient, respx_mock):
    """Test that division endpoints forward query parameters correctly."""
