...
@pytest.mark.parametrize(
    ...
    [
        ("/api/v1/venues", "venues", "View venue info"),
        ("/api/v1/venues/123", "venues_1", "View venue info"),
    ],
)
def test_venues_endpoint_exists(
    client: TestClient, endpoint_path: str, operation_id: str, summary: str, respx_mock
):
    """Test that venues endpoint exists and returns expected structure."""
...
@pytest.mark.unit
def test_venues_endpoints_require_valid_upstream(client: TestClient, respx_mock):
    """Test that venues endpoints handle upstream failures gracefully."""
...
@pytest.mark.unit
def test_venues_endpoints_forward_query_params(client: TestClient, respx_mock):
    """Test that venues endpoints forward query parameters correctly."""
